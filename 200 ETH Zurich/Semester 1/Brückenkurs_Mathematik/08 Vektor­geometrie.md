[[408_skript_vektorgeometrie_grundlagen.pdf]]<br>
[[409_skript_vektorgeometrie_geraden_und_ebenen.pdf]]<br>
[[410_skript_vektorgeometrie_skp_normalformen.pdf]]<br>
...
- **Scalar (Scalar):** A quantity defined by a magnitude (number) and possibly a unit (e.g., temperature, distance, speed/tempo) 111111111.
...
## 1.4. Norm (Länge) eines Vectors (Norm/Length of a Vector)
